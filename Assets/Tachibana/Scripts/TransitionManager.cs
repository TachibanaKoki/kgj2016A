...
public class TransitionManager : MonoBehaviour
{
    ...
    public void FadeOut(float duration = 1.0f, System.Action action = null)
    {
        StartCoroutine(FadeOutCoroutine(duration, action));
    }

    IEnumerator FadeOutCoroutine(float duration, System.Action action = null)
    {
        float timer = 0.0f;
        float delta = (1.0f / duration);
